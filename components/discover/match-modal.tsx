        ...
        <div className="p-6 text-center">
          ...
          >
            ...
            <p className="text-white/80 mb-8">
              {superLike
                ? 'They super-liked you too! ✨'
                : "You both liked each other's music taste"}
            </p>
          </div>
            ...
            <div className="flex flex-wrap justify-center gap-1 mb-3">
              {user.topGenres.map((genre: string, index: number) => (
                <Badge
                  key={index}
                  variant="secondary"
                  className="bg-white/20 hover:bg-white/20 text-white border-none"
                >
                  {genre}
                </Badge>
              ))}
            ...
            <div className="flex items-center space-x-3 bg-white/10 backdrop-blur-sm rounded-lg p-2 max-w-xs mx-auto">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium truncate">
                  {user.anthem.trackName}
                </p>
                <p className="text-xs text-gray-300 truncate">
                  {user.anthem.artistName}
                </p>
              </div>
              <Button
                variant="secondary"
