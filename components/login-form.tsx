...
// Mock API functions that will be replaced with actual API calls
  ...
  return (
    <Card className="w-full shadow-lg border-0 bg-white/80 backdrop-blur-sm dark:bg-gray-950/80">
      <CardHeader className="space-y-1">
        ...
        <CardDescription className="text-center">Sign in with your music streaming service</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        >
          {isLoading.spotify ? (
            ...
            <svg className="mr-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" fill="currentColor">
